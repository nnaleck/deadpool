        ...
        tabPanel(
            ...
            tabsetPanel(
                tabPanel(
                    "Data summary",
                    fluidRow(
                        column(6, h3("Student grade prediction dataset"), textOutput(outputId = "resumeIt")),
                        column(6, tableOutput(outputId = "dict"))
                    )
                ),
                tabPanel(
                "Univariate analysis",
                     sidebarLayout(
                        ...
                        mainPanel(
                            fluidRow(
                                column(6, plotlyOutput(outputId = "effectifsHist")),
                                column(6, plotlyOutput(outputId = "frequenceHist"))
                            ),
                            fluidRow(
                                column(6, plotlyOutput(outputId = "effectifsCumCurve")),
                        ...
                        mainPanel(
                            fluidRow(
                                column(
                                    6,
                                    fluidRow(
                                        column(8, plotlyOutput(outputId = "nuagePointsBiv")),
